...
# Nested Fields 0
[trainer]
checkpoint_savepath = "Path" # Directory path to save checkpoint.
checkpoint_basename = "checkpoint" # Base name of the checkpoint for save/load.
...
'''
    with open(f"configs/preprocess/{split_method}.toml", "w") as f:
        f.write(s_toml)