...
# Nested Fields 0
[trainer]
checkpoint_savepath = "checkpoints/MAEGIN_{split_method}_{mask_method}" # Directory path to save checkpoint.
checkpoint_basename = "MAEGIN_{split_method}_{mask_method}" # Base name of the checkpoint for save/load.
...
# Nested Fields 4
[train_dataset]
meta_filepath = "data/{split_method}/training/meta.json" # Path to the metadata file that describes the dataset.
raw_dirpath = "data/{split_method}/training/items" # Directory containing raw input data files.
processed_dirpath = "data/{split_method}/training/processed" # Directory where processed dataset should be stored.
worker_number = 4 # Number of workers for parallel data loading or processing.

# Nested Fields 5
[valid_dataset]
meta_filepath = "data/{split_method}/validation/meta.json" # Path to the metadata file that describes the dataset.
raw_dirpath = "data/{split_method}/validation/items" # Directory containing raw input data files.
processed_dirpath = "data/{split_method}/validation/processed" # Directory where processed dataset should be stored.
worker_number = 4 # Number of workers for parallel data loading or processing.

# Nested Fields 6
[test_dataset]
meta_filepath = "data/{split_method}/test/meta.json" # Path to the metadata file that describes the dataset.
raw_dirpath = "data/{split_method}/test" # Directory containing raw input data files.
processed_dirpath = "data/{split_method}/test" # Directory where processed dataset should be stored.
worker_number = 4 # Number of workers for parallel data loading or processing.
...
'''
        with open(f"configs/train/MAEGIN_{split_method}_{mask_method}.toml", "w") as f:
            f.write(s_toml)