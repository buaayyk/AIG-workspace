...
# Nested Fields 6
[test_dataset]
meta_filepath = "data/MixSuper/test/meta.json" # Path to the metadata file that describes the dataset.
raw_dirpath = "data/MixSuper/test" # Directory containing raw input data files.
processed_dirpath = "data/MixSuper/test" # Directory where processed dataset should be stored.
worker_number = 4 # Number of workers for parallel data loading or processing.
